...
def recursive_loc(owner, repo_name, data, cache_comment, addition_total=0, deletion_total=0, my_commits=0, cursor=None, retries=5):
    """
    ...
    if request.status_code in (502, 403) and retries > 0:
        delay = 2 ** (5 - retries)
        time.sleep(delay)
